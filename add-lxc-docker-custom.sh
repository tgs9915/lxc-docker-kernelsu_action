...
CONFIG_NF_TABLES_CHAIN=y
CONFIG_NF_TABLES_EVAL=y
...
CONFIG_IP_SET_HASH_NETNETNET=y
CONFIG_IP_SET_HASH_NETPORTNETPORT=y
CONFIG_IP_SET_HASH_IPPORTIPPORT=y
